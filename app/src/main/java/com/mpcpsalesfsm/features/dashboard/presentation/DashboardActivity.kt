package com.mpcpsalesfsm.features.dashboard.presentation
...
import com.mpcpsalesfsm.app.NewFileUtils.browseDocuments
import com.mpcpsalesfsm.app.NewFileUtils.browsePDFDocuments
import com.mpcpsalesfsm.app.NewFileUtils.getExtension
import com.mpcpsalesfsm.app.domain.*
import com.mpcpsalesfsm.app.types.DashboardType
import com.mpcpsalesfsm.app.types.FragType
import com.mpcpsalesfsm.app.types.TopBarConfig
import com.mpcpsalesfsm.app.uiaction.DisplayAlert
import com.mpcpsalesfsm.app.utils.*
import com.mpcpsalesfsm.app.utils.AppUtils.Companion.isProfile
...
import com.mpcpsalesfsm.features.NewQuotation.*
import com.mpcpsalesfsm.features.NewQuotation.api.GetQuotRegProvider
import com.mpcpsalesfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.mpcpsalesfsm.features.SearchLocation.SearchLocationFragment
import com.mpcpsalesfsm.features.SearchLocation.locationInfoModel
import com.mpcpsalesfsm.features.TA.ViewAllTAListFragment
import com.mpcpsalesfsm.features.achievement.AchievementFragment
import com.mpcpsalesfsm.features.activities.presentation.*
import com.mpcpsalesfsm.features.addAttendence.*
import com.mpcpsalesfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.mpcpsalesfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.mpcpsalesfsm.features.addAttendence.model.GetReportToFCMResponse
import com.mpcpsalesfsm.features.addAttendence.model.GetReportToResponse
import com.mpcpsalesfsm.features.addAttendence.model.Leave_list_Response
import com.mpcpsalesfsm.features.addorder.presentation.AddOrderFragment
...
import com.mpcpsalesfsm.features.addshop.presentation.AddShopFragment
import com.mpcpsalesfsm.features.addshop.presentation.OTPVerificationDialog
import com.mpcpsalesfsm.features.addshop.presentation.ScanImageFragment
import com.mpcpsalesfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.mpcpsalesfsm.features.alarm.model.AlarmData
import com.mpcpsalesfsm.features.alarm.presetation.AttendanceReportFragment
import com.mpcpsalesfsm.features.alarm.presetation.PerformanceReportFragment
import com.mpcpsalesfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.mpcpsalesfsm.features.alarm.presetation.VisitReportFragment
import com.mpcpsalesfsm.features.attendance.AttendanceFragment
import com.mpcpsalesfsm.features.attendance.api.AttendanceRepositoryProvider
import com.mpcpsalesfsm.features.attendance.model.AttendanceRequest
import com.mpcpsalesfsm.features.attendance.model.AttendanceResponse
import com.mpcpsalesfsm.features.averageshop.presentation.AverageShopFragment
import com.mpcpsalesfsm.features.avgorder.presentation.AverageOrderFragment
import com.mpcpsalesfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.mpcpsalesfsm.features.beatCustom.TeamBeatListFragment
import com.mpcpsalesfsm.features.billing.presentation.AddBillingFragment
import com.mpcpsalesfsm.features.billing.presentation.BillingDetailsFragment
import com.mpcpsalesfsm.features.billing.presentation.BillingListFragment
import com.mpcpsalesfsm.features.changepassword.presentation.ChangePasswordDialog
import com.mpcpsalesfsm.features.chat.model.ChatListDataModel
import com.mpcpsalesfsm.features.chat.model.ChatUserDataModel
import com.mpcpsalesfsm.features.chat.model.GroupUserDataModel
import com.mpcpsalesfsm.features.chat.presentation.*
import com.mpcpsalesfsm.features.chatbot.presentation.ChatBotFragment
import com.mpcpsalesfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.mpcpsalesfsm.features.chatbot.presentation.ReportsFragment
import com.mpcpsalesfsm.features.chatbot.presentation.SelectLanguageDialog
...
import com.mpcpsalesfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
...
import com.mpcpsalesfsm.features.damageProduct.ShopDamageProductListFrag
import com.mpcpsalesfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.mpcpsalesfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.mpcpsalesfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.mpcpsalesfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.mpcpsalesfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.mpcpsalesfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.mpcpsalesfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.mpcpsalesfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.mpcpsalesfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.mpcpsalesfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.mpcpsalesfsm.features.device_info.presentation.DeviceInfoListFragment
import com.mpcpsalesfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.mpcpsalesfsm.features.document.DocumentRepoFeatureNewFragment
import com.mpcpsalesfsm.features.document.presentation.DocumentListFragment
import com.mpcpsalesfsm.features.document.presentation.DocumentTypeListFragment
import com.mpcpsalesfsm.features.document.presentation.OpenFileWebViewFragment
import com.mpcpsalesfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.mpcpsalesfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.mpcpsalesfsm.features.dymanicSection.presentation.DynamicListFragment
import com.mpcpsalesfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.mpcpsalesfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.mpcpsalesfsm.features.home.presentation.HomeFragment
import com.mpcpsalesfsm.features.homelocation.presentation.HomeLocationFragment
import com.mpcpsalesfsm.features.homelocation.presentation.HomeLocationMapFragment
...
import com.mpcpsalesfsm.features.localshops.LocalShopListMapFragment
import com.mpcpsalesfsm.features.localshops.NearByShopsMapFragment
import com.mpcpsalesfsm.features.location.*
import com.mpcpsalesfsm.features.location.api.LocationRepoProvider
import com.mpcpsalesfsm.features.location.model.*
import com.mpcpsalesfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.mpcpsalesfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.mpcpsalesfsm.features.login.ShopFeedbackEntity
import com.mpcpsalesfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.mpcpsalesfsm.features.login.presentation.LoginActivity
import com.mpcpsalesfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.mpcpsalesfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.mpcpsalesfsm.features.marketAssist.MarketAssistTabFrag
import com.mpcpsalesfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.mpcpsalesfsm.features.marketAssist.ShopListMarketAssistFrag
import com.mpcpsalesfsm.features.marketing.presentation.MarketingPagerFragment
import com.mpcpsalesfsm.features.meetinglist.prsentation.MeetingListFragment
import com.mpcpsalesfsm.features.member.MapViewForTeamFrag
import com.mpcpsalesfsm.features.member.model.TeamLocDataModel
import com.mpcpsalesfsm.features.member.model.TeamShopListDataModel
import com.mpcpsalesfsm.features.member.presentation.*
import com.mpcpsalesfsm.features.menuBeat.MenuBeatFrag
import com.mpcpsalesfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.mpcpsalesfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.mpcpsalesfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
...
import com.mpcpsalesfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.mpcpsalesfsm.features.nearbyshops.presentation.BeatListFragment
import com.mpcpsalesfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.mpcpsalesfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.mpcpsalesfsm.features.nearbyshops.presentation.ShopCallHisFrag
import com.mpcpsalesfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.mpcpsalesfsm.features.newcollection.CollectionDetailsStatusFragment
import com.mpcpsalesfsm.features.newcollection.CollectionShopListFragment
...
import com.mpcpsalesfsm.features.orderdetail.presentation.OrderDetailFragment
import com.mpcpsalesfsm.features.orderhistory.ActivityMapFragment
import com.mpcpsalesfsm.features.orderhistory.OrderhistoryFragment
import com.mpcpsalesfsm.features.orderhistory.TimeLineFragment
...
import com.mpcpsalesfsm.features.orderhistory.model.FetchLocationResponse
import com.mpcpsalesfsm.features.orderhistory.model.LocationData
import com.mpcpsalesfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.mpcpsalesfsm.features.performance.GpsStatusFragment
import com.mpcpsalesfsm.features.performance.PerformanceFragment
import com.mpcpsalesfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.mpcpsalesfsm.features.performance.model.UpdateGpsInputParamsModel
import com.mpcpsalesfsm.features.performanceAPP.OwnPerformanceFragment
import com.mpcpsalesfsm.features.performanceAPP.PerformanceAppFragment
import com.mpcpsalesfsm.features.performanceAPP.allPerformanceFrag
import com.mpcpsalesfsm.features.permissionList.ViewPermissionFragment
import com.mpcpsalesfsm.features.photoReg.*
import com.mpcpsalesfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.mpcpsalesfsm.features.quotation.presentation.*
import com.mpcpsalesfsm.features.reimbursement.presentation.*
import com.mpcpsalesfsm.features.report.presentation.*
import com.mpcpsalesfsm.features.returnsOrder.*
import com.mpcpsalesfsm.features.settings.presentation.SettingsFragment
import com.mpcpsalesfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.mpcpsalesfsm.features.shopdetail.presentation.*
import com.mpcpsalesfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.mpcpsalesfsm.features.stock.StockDetailsFragment
import com.mpcpsalesfsm.features.stock.StockListFragment
import com.mpcpsalesfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.mpcpsalesfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.mpcpsalesfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.mpcpsalesfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.mpcpsalesfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.mpcpsalesfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.mpcpsalesfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.mpcpsalesfsm.features.survey.SurveyFrag
import com.mpcpsalesfsm.features.survey.SurveyViewDtlsFrag
import com.mpcpsalesfsm.features.survey.SurveyViewFrag
import com.mpcpsalesfsm.features.task.presentation.AddTaskFragment
import com.mpcpsalesfsm.features.task.presentation.CalenderTaskFragment
import com.mpcpsalesfsm.features.task.presentation.EditTaskFragment
import com.mpcpsalesfsm.features.task.presentation.TaskListFragment
import com.mpcpsalesfsm.features.taskManagement.TaskManagementFrag
import com.mpcpsalesfsm.features.taskManagement.ViewTaskManagementFrag
import com.mpcpsalesfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.mpcpsalesfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.mpcpsalesfsm.features.timesheet.presentation.TimeSheetListFragment
import com.mpcpsalesfsm.features.viewAllOrder.CartFragment
import com.mpcpsalesfsm.features.viewAllOrder.OrderTypeListFragment
import com.mpcpsalesfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.mpcpsalesfsm.features.viewAllOrder.ViewCartFragment
import com.mpcpsalesfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.mpcpsalesfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.mpcpsalesfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.mpcpsalesfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.mpcpsalesfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.mpcpsalesfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.mpcpsalesfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.mpcpsalesfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.mpcpsalesfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.mpcpsalesfsm.features.viewPPDDStock.ViewStockFragment
import com.mpcpsalesfsm.features.weather.presentation.WeatherFragment
import com.mpcpsalesfsm.mappackage.MapActivity
import com.mpcpsalesfsm.mappackage.MapActivityWithoutPath
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xmpcpsalesfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmpcpsalesfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.mpcpsalesfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmpcpsalesfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmpcpsalesfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmpcpsalesfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmpcpsalesfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
